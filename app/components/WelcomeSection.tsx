  ...
  return (
    ...
    >
      <div className="relative mx-auto max-w-[69.375rem] px-8 py-20 md:py-32 lg:px-0">
        <p
          aria-hidden="true"
          className="pointer-events-none absolute z-10 hidden select-none whitespace-nowrap font-bold leading-none tracking-[-0.06em] text-surface md:left-30 md:top-[5rem] md:block md:text-[7rem] lg:left-0 lg:top-[6rem] lg:text-[15rem]"
        >
          Welcome
        </p>
        ...
        <div className="relative lg:mt-25 lg:flex lg:items-center lg:justify-center lg:gap-30">
          ...
          <figure className="relative mt-12 hidden aspect-[350/568] w-full max-w-[350px] self-start md:mt-0 lg:block">
            <Image
              src={welcome.image}
